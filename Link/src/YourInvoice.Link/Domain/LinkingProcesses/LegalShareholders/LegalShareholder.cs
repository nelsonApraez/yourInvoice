...
{
    public class LegalShareholder : AggregateRoot
    {
        public LegalShareholder() { }

        public LegalShareholder(Guid id, Guid id_LegalGeneralInformation,string fullNameCompanyName, Guid documentTypeId, string documentNumber, string phoneNumber,
