...
namespace yourInvoice.Offer.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext, IApplicationDbContext, IUnitOfWork
    {
        ...
        public DbSet<Common.Entities.CatalogItemInfo> CatalogItems { get; set; }

        public DbSet<Common.Entities.CatalogInfo> Catalog { get; set; }
        ...
        public DbSet<DianFyMFile> DianFyMFiles { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountInfo>().ToTable(nameof(AccountInfo), t => t.ExcludeFromMigrations());

            modelBuilder.ApplyConfiguration(new AccountInfoMapper());
        }
